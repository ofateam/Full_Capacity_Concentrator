...
Full Capacity Buffered Concentrator (designed by Emre Gunduzhan) Implementation in Python. You can create your concentrators with a few parameters, and test them by examining the output buffers displayed on the screen by the program.
